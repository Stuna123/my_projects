    ...
    <body>
        ...
        <div class="container admin">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <h1><strong> <span class="glyphicon glyphicon-shopping-cart"></span> Panier </strong></h1>
                    <br />
                    <form>
                    ...
                    <div class="form-actions">
                        <a class="btn btn-primary" href="../index2.php"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
                    </div>
                    
                </div>
                
                <!-- On separe à deux le site pour mettre de l'autre côté l'image -->
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <a href="../Compteur.php" class="btn btn-order" role="button"><span class="glyphicon glyphicon-shopping-cart"></span> Commander</a>
                        </div>
                    </div>
                </div>
